...
var SolanaWallet = class {
  ...
  signTransaction(transaction) {
    return __async2(this, null, function* () {
      const signature = yield this.auth.sign(
        "signTransaction",
        esm_default.encode(transaction.serialize({ requireAllSignatures: false, verifySignatures: false }))
      );
  ...
  signAllTransactions(transactions) {
    return __async2(this, null, function* () {
      const signatures = yield this.auth.signAllTransactions(
        transactions.map(
          (tx) => esm_default.encode(tx.serialize({ requireAllSignatures: false, verifySignatures: false }))
        )
      );
  ...
  signMessage(message) {
    return __async2(this, null, function* () {
      const signature = yield this.auth.sign("signMessage", esm_default.encode(message));
...
//# sourceMappingURL=es-P4HL7EMX.js.map
