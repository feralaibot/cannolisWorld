...
var ICONS = {
  add: async () => (await import("./add-FPAKIAHV.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-7TXKK2P4.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-VGIBHBZ3.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-534ZOM75.js")).appStoreSvg,
  apple: async () => (await import("./apple-KZYOGV5I.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-FTN5R277.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-I7WVC7WG.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-IIDNVLRG.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-ABTUDPFM.js")).arrowTopSvg,
  bank: async () => (await import("./bank-TVNAJW2F.js")).bankSvg,
  browser: async () => (await import("./browser-5XOUX6TA.js")).browserSvg,
  card: async () => (await import("./card-5X7OTIYQ.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-ZT37I5RB.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-QGIK3JWK.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-PRWBGJT7.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-ABRBY4OY.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-S6STIJTY.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-DBWY7WCV.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-FS5LU35S.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-AMMNMCFI.js")).clockSvg,
  close: async () => (await import("./close-TVK6LPPU.js")).closeSvg,
  compass: async () => (await import("./compass-LEACUTOL.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-MGUBSCVM.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-WCEKFXNI.js")).copySvg,
  cursor: async () => (await import("./cursor-4G55A2C3.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-2TMAKYZQ.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-Q3TISIBE.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-VXSSNMAI.js")).disconnectSvg,
  discord: async () => (await import("./discord-LXBZKWQ2.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-JXR2M4JR.js")).etherscanSvg,
  extension: async () => (await import("./extension-6WMIQOK6.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-NO6ZMOM7.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-S34KYDAB.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-J7VTT3TL.js")).farcasterSvg,
  filters: async () => (await import("./filters-PMG6UKI4.js")).filtersSvg,
  github: async () => (await import("./github-NWS4ZURC.js")).githubSvg,
  google: async () => (await import("./google-ZPM2IAGD.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-Z3TA4XME.js")).helpCircleSvg,
  image: async () => (await import("./image-4CFUVI7K.js")).imageSvg,
  id: async () => (await import("./id-6UMHBEFY.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-RQBCXQTU.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-PUHDOPUC.js")).lightbulbSvg,
  mail: async () => (await import("./mail-PWRHKGB3.js")).mailSvg,
  mobile: async () => (await import("./mobile-ZOH7EFTG.js")).mobileSvg,
  more: async () => (await import("./more-CL4MCALN.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-P7FGLOPL.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-V4OB7Q3U.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-7TADBDUH.js")).offSvg,
  playStore: async () => (await import("./play-store-TAWCUBEP.js")).playStoreSvg,
  plus: async () => (await import("./plus-ZSJT4373.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-6NBFKOTC.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-7DITOOYS.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-6WDHZMFC.js")).refreshSvg,
  search: async () => (await import("./search-PGAHLL7Q.js")).searchSvg,
  send: async () => (await import("./send-BMAYYK3B.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-W3ULP5LU.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-LOYPIBCS.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-TMG5TEVK.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-AQYXDA2B.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-44A246SH.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-CGI52UEF.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-PMPJZ6ZS.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-KECJWWNL.js")).twitchSvg,
  twitter: async () => (await import("./x-NARDNDWX.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-ZIMH4GD6.js")).twitterIconSvg,
  verify: async () => (await import("./verify-KP4ICTG7.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-JX63JKXW.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-PQ4BKLAB.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-MU67YZLH.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-MU67YZLH.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-MU67YZLH.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-DG3RXGXQ.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-2CRITTJS.js")).warningCircleSvg,
  x: async () => (await import("./x-NARDNDWX.js")).xSvg,
  info: async () => (await import("./info-4OGSSI4L.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-IPU2T6QG.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-SZV5SD4Q.js")).reownSvg
};
...
//# sourceMappingURL=chunk-VLT2O26D.js.map
