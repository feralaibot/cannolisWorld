...
import {
  ...
  validate2,
  validateObject
} from "./chunk-VA4MF6GH.js";
import {
  require_elliptic
} from "./chunk-ISWHRDMN.js";
import {
  require_events
...
import {
  ...
  init_sha2,
  sha256
} from "./chunk-GOCGMA7Z.js";
import {
  init_sha3,
  keccak_256
} from "./chunk-PWBYASA3.js";
import {
  anumber,
  clean,
  concatBytes,
...
var require_dayjs_min = __commonJS({
  "node_modules/dayjs/dayjs.min.js"(exports, module) {
    !(function(t2, e2) {
      ...
      "use strict";
      var t2 = 1e3, e2 = 6e4, n5 = 36e5, r3 = "millisecond", i5 = "second", s4 = "minute", u3 = "hour", a3 = "day", o5 = "week", c7 = "month", f7 = "quarter", h6 = "year", d5 = "date", l8 = "Invalid Date", $ = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, y5 = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, M4 = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(t3) {
        var e3 = ["th", "st", "nd", "rd"], n6 = t3 % 100;
        return "[" + t3 + (e3[(n6 - 20) % 10] || e3[n6] || e3[0]) + "]";
      } }, m4 = function(t3, e3, n6) {
        var r4 = String(t3);
        return !r4 || r4.length >= e3 ? t3 : "" + Array(e3 + 1 - r4.length).join(n6) + t3;
      }, v5 = { s: m4, z: function(t3) {
        var e3 = -t3.utcOffset(), n6 = Math.abs(e3), r4 = Math.floor(n6 / 60), i6 = n6 % 60;
        return (e3 <= 0 ? "+" : "-") + m4(r4, 2, "0") + ":" + m4(i6, 2, "0");
      }, m: function t3(e3, n6) {
        if (e3.date() < n6.date()) return -t3(n6, e3);
        var r4 = 12 * (n6.year() - e3.year()) + (n6.month() - e3.month()), i6 = e3.clone().add(r4, c7), s5 = n6 - i6 < 0, u4 = e3.clone().add(r4 + (s5 ? -1 : 1), c7);
      ...
      b4.l = w4, b4.i = S3, b4.w = function(t3, e3) {
        return O6(t3, { locale: e3.$L, utc: e3.$u, x: e3.$x, $offset: e3.$offset });
      };
      var _4 = (function() {
        function M5(t3) {
        ...
        return m5.parse = function(t3) {
        ...
        }, m5.isSame = function(t3, e3) {
          var n6 = O6(t3);
          return this.startOf(e3) <= n6 && n6 <= this.endOf(e3);
        }, m5.isAfter = function(t3, e3) {
          return O6(t3) < this.startOf(e3);
        }, m5.isBefore = function(t3, e3) {
          return this.endOf(e3) < O6(t3);
        }, m5.$g = function(t3, e3, n6) {
          return b4.u(t3) ? this[e3] : this.set(n6, t3);
        }, m5.unix = function() {
          return Math.floor(this.valueOf() / 1e3);
        }, m5.valueOf = function() {
          return this.$d.getTime();
        }, m5.startOf = function(t3, e3) {
          var n6 = this, r4 = !!b4.u(e3) || e3, f8 = b4.p(t3), l9 = function(t4, e4) {
            var i6 = b4.w(n6.$u ? Date.UTC(n6.$y, e4, t4) : new Date(n6.$y, e4, t4), n6);
            return r4 ? i6 : i6.endOf(a3);
          }, $2 = function(t4, e4) {
            return b4.w(n6.toDate()[t4].apply(n6.toDate("s"), (r4 ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e4)), n6);
        ...
        }, m5.$set = function(t3, e3) {
          var n6, o6 = b4.p(t3), f8 = "set" + (this.$u ? "UTC" : ""), l9 = (n6 = {}, n6[a3] = f8 + "Date", n6[d5] = f8 + "Date", n6[c7] = f8 + "Month", n6[h6] = f8 + "FullYear", n6[u3] = f8 + "Hours", n6[s4] = f8 + "Minutes", n6[i5] = f8 + "Seconds", n6[r3] = f8 + "Milliseconds", n6)[o6], $2 = o6 === a3 ? this.$D + (e3 - this.$W) : e3;
          if (o6 === c7 || o6 === h6) {
          ...
          var $2 = b4.p(f8), y6 = function(t3) {
            var e3 = O6(l9);
            return b4.w(e3.date(e3.date() + Math.round(t3 * r4)), l9);
          };
          if ($2 === c7) return this.set(c7, this.$M + r4);
          if ($2 === h6) return this.set(h6, this.$y + r4);
          if ($2 === a3) return y6(1);
          if ($2 === o5) return y6(7);
          var M6 = (d6 = {}, d6[s4] = e2, d6[u3] = n5, d6[i5] = t2, d6)[$2] || 1, m6 = this.$d.getTime() + r4 * M6;
          return b4.w(m6, this);
        }, m5.subtract = function(t3, e3) {
          ...
          var r4 = t3 || "YYYY-MM-DDTHH:mm:ssZ", i6 = b4.z(this), s5 = this.$H, u4 = this.$m, a4 = this.$M, o6 = n6.weekdays, c8 = n6.months, f8 = n6.meridiem, h7 = function(t4, n7, i7, s6) {
            return t4 && (t4[n7] || t4(e3, r4)) || i7[n7].slice(0, s6);
          }, d6 = function(t4) {
            return b4.s(s5 % 12 || 12, t4, "0");
          }, $2 = f8 || function(t4, e4, n7) {
            var r5 = t4 < 12 ? "AM" : "PM";
          ...
          var $2, y6 = this, M6 = b4.p(d6), m6 = O6(r4), v6 = (m6.utcOffset() - this.utcOffset()) * e2, g5 = this - m6, D3 = function() {
            return b4.m(y6, m6);
          };
          switch (M6) {
            case h6:
          ...
          return D2[this.$L];
        }, m5.locale = function(t3, e3) {
          if (!t3) return this.$L;
          var n6 = this.clone(), r4 = w4(t3, e3, true);
      ...
      })), O6.extend = function(t3, e3) {
        return t3.$i || (t3(e3, _4, O6), t3.$i = true), O6;
  ...
  "node_modules/dayjs/locale/en.js"(exports, module) {
    !(function(e2, n5) {
      ...
      return { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(e2) {
        var n5 = ["th", "st", "nd", "rd"], t2 = e2 % 100;
        return "[" + e2 + (n5[(t2 - 20) % 10] || n5[t2] || n5[0]) + "]";
      } };
    }));
  }
});
  ...
  "node_modules/dayjs/plugin/relativeTime.js"(exports, module) {
    !(function(r3, e2) {
      ...
      return function(r3, e2, t2) {
        ...
        function i5(r4, e3, t3, o6) {
          return n5.fromToBase(r4, e3, t3, o6);
        }
        t2.en.relativeTime = o5, n5.fromToBase = function(e3, n6, i6, d6, u3) {
          for (var f7, a3, s4, l8 = i6.$locale().relativeTime || o5, h6 = r3.thresholds || [{ l: "s", r: 44, d: "second" }, { l: "m", r: 89 }, { l: "mm", r: 44, d: "minute" }, { l: "h", r: 89 }, { l: "hh", r: 21, d: "hour" }, { l: "d", r: 35 }, { l: "dd", r: 25, d: "day" }, { l: "M", r: 45 }, { l: "MM", r: 10, d: "month" }, { l: "y", r: 17 }, { l: "yy", d: "year" }], m4 = h6.length, c7 = 0; c7 < m4; c7 += 1) {
            var y5 = h6[c7];
            y5.d && (f7 = d6 ? t2(e3).diff(i6, y5.d, true) : i6.diff(e3, y5.d, true));
          ...
          return i5(r4, e3, this, true);
        }, n5.from = function(r4, e3) {
          return i5(r4, e3, this);
        };
        var d5 = function(r4) {
...
var require_updateLocale = __commonJS({
  "node_modules/dayjs/plugin/updateLocale.js"(exports, module) {
    !(function(e2, n5) {
      ...
      "use strict";
      return function(e2, n5, t2) {
        t2.updateLocale = function(e3, n6) {
          var o5 = t2.Ls[e3];
          if (o5) return (n6 ? Object.keys(n6) : []).forEach((function(e4) {
            o5[e4] = n6[e4];
          })), o5;
        };
      };
...
function __rest(s4, e2) {
  var t2 = {};
  for (var p4 in s4) if (Object.prototype.hasOwnProperty.call(s4, p4) && e2.indexOf(p4) < 0)
    t2[p4] = s4[p4];
  if (s4 != null && typeof Object.getOwnPropertySymbols === "function")
    for (var i5 = 0, p4 = Object.getOwnPropertySymbols(s4); i5 < p4.length; i5++) {
      if (e2.indexOf(p4[i5]) < 0 && Object.prototype.propertyIsEnumerable.call(s4, p4[i5]))
        t2[p4[i5]] = s4[p4[i5]];
    }
  return t2;
}
...
function parse(x6, n5) {
  ...
  if ((e2 = n5.indexOf(".")) > -1) n5 = n5.replace(".", "");
  ...
  if (i5 == nl) {
    ...
    x6.e = e2 - i5 - 1;
    x6.c = [];
    for (e2 = 0; i5 <= nl; ) x6.c[e2++] = +n5.charAt(i5++);
  }
  return x6;
}
...
function stringify3(x6, doExponential, isNonzero) {
  var e2 = x6.e, s4 = x6.c.join(""), n5 = s4.length;
  if (doExponential) {
    s4 = s4.charAt(0) + (n5 > 1 ? "." + s4.slice(1) : "") + (e2 < 0 ? "e" : "e+") + e2;
  } else if (e2 < 0) {
    for (; ++e2; ) s4 = "0" + s4;
    s4 = "0." + s4;
  } else if (e2 > 0) {
...
P.plus = P.add = function(y5) {
  var e2, k5, t2, x6 = this, Big2 = x6.constructor;
  y5 = new Big2(y5);
  if (x6.s != y5.s) {
    y5.s = -y5.s;
    return x6.minus(y5);
  ...
  e2 = yc.length;
  for (k5 = 0; e2; xc[e2] %= 10) k5 = (xc[--e2] = xc[e2] + yc[e2] + k5) / 10 | 0;
  if (k5) {
    xc.unshift(k5);
    ++ye2;
  }
...
P.sqrt = function() {
  var r3, c7, t2, x6 = this, Big2 = x6.constructor, s4 = x6.s, e2 = x6.e, half = new Big2("0.5");
  ...
  if (s4 === 0 || s4 === 1 / 0) {
    c7 = x6.c.join("");
    if (!(c7.length + e2 & 1)) c7 += "0";
    s4 = Math.sqrt(c7);
    e2 = ((e2 + 1) / 2 | 0) - (e2 < 0 || e2 & 1);
    r3 = new Big2((s4 == 1 / 0 ? "5e" : (s4 = s4.toExponential()).slice(0, s4.indexOf("e") + 1)) + e2);
  } else {
    r3 = new Big2(s4 + "");
  }
  e2 = r3.e + (Big2.DP += 4);
  ...
  } while (t2.c.slice(0, e2).join("") !== r3.c.slice(0, e2).join(""));
...
var i2 = class _i extends n {
  constructor(e2) {
    super(e2), this.events = new import_events.EventEmitter(), this.interval = s2, this.interval = e2?.interval || s2;
  }
...
var x = "idb-keyval";
var z = (i5 = {}) => {
  const t2 = i5.base && i5.base.length > 0 ? `${i5.base}:` : "", e2 = (s4) => t2 + s4;
  let n5;
  return i5.dbName && i5.storeName && (n5 = createStore(i5.dbName, i5.storeName)), { name: x, options: i5, async hasItem(s4) {
    return !(typeof await get(e2(s4), n5) > "u");
  }, async getItem(s4) {
    return await get(e2(s4), n5) ?? null;
  }, setItem(s4, a3) {
    return set(e2(s4), a3, n5);
  }, removeItem(s4) {
    return del(e2(s4), n5);
  }, getKeys() {
    return keys(n5);
...
(function() {
  ...
  i5 = t2, i5.prototype.getItem = function(e2) {
...
var O = async (i5, t2, e2) => {
  ...
  await t2.setItem(n5, y2), e2(t2), j(i5, m4);
};
var j = async (i5, t2) => {
...
var L = class {
  constructor(e2, t2 = l4) {
    this.level = e2 ?? "error", this.levelValue = import_pino.levels.values[this.level], this.MAX_LOG_SIZE_IN_BYTES = t2, this.logs = new d(this.MAX_LOG_SIZE_IN_BYTES);
  }
  forwardToConsole(e2, t2) {
    t2 === import_pino.levels.values.error ? console.error(e2) : t2 === import_pino.levels.values.warn ? console.warn(e2) : t2 === import_pino.levels.values.debug ? console.debug(e2) : t2 === import_pino.levels.values.trace ? console.trace(e2) : console.log(e2);
  }
  appendToLogs(e2) {
...
var m = class {
  constructor(e2, t2 = l4) {
    this.baseChunkLogger = new L(e2, t2);
  }
  write(e2) {
  ...
  downloadLogsBlobInBrowser(e2) {
    const t2 = URL.createObjectURL(this.logsToBlob(e2)), o5 = document.createElement("a");
...
var f2 = (r3, e2, t2) => e2 in r3 ? x2(r3, e2, { enumerable: true, configurable: true, writable: true, value: t2 }) : r3[e2] = t2;
var i3 = (r3, e2) => {
  for (var t2 in e2 || (e2 = {})) T.call(e2, t2) && f2(r3, t2, e2[t2]);
  if (p) for (var t2 of p(e2)) z2.call(e2, t2) && f2(r3, t2, e2[t2]);
  return r3;
};
...
function b(r3, e2, t2 = n2) {
  return r3[t2] = e2, r3;
}
function y3(r3, e2 = n2) {
  let t2 = "";
  return typeof r3.bindings > "u" ? t2 = v(r3, e2) : t2 = r3.bindings().context || "", t2;
}
function w(r3, e2, t2 = n2) {
  const o5 = y3(r3, t2);
  return o5.trim() ? `${o5}/${e2}` : e2;
}
function E2(r3, e2, t2 = n2) {
  const o5 = w(r3, e2, t2), a3 = r3.child({ context: o5 });
  return b(a3, o5, t2);
}
function C(r3) {
  var e2, t2;
...
function I(r3) {
  var e2;
  const t2 = new B((e2 = r3.opts) == null ? void 0 : e2.level, r3.maxSizeInBytes);
...
var u2 = (e2, s4, r3) => s4 in e2 ? a2(e2, s4, { enumerable: true, configurable: true, writable: true, value: r3 }) : e2[s4] = r3;
var c4 = (e2, s4, r3) => u2(e2, typeof s4 != "symbol" ? s4 + "" : s4, r3);
...
var b2 = (e2, s4, r3) => s4 in e2 ? p2(e2, s4, { enumerable: true, configurable: true, writable: true, value: r3 }) : e2[s4] = r3;
var v2 = (e2, s4, r3) => b2(e2, typeof s4 != "symbol" ? s4 + "" : s4, r3);
...
var k3 = (e2, s4, r3) => s4 in e2 ? T2(e2, s4, { enumerable: true, configurable: true, writable: true, value: r3 }) : e2[s4] = r3;
var i4 = (e2, s4, r3) => k3(e2, typeof s4 != "symbol" ? s4 + "" : s4, r3);
var J = class {
  constructor(s4) {
...
function Bn(t2) {
  const e2 = (r3) => t2().update(de(r3)).digest(), n5 = t2();
  return e2.outputLen = n5.outputLen, e2.blockLen = n5.blockLen, e2.create = () => t2(), e2;
}
function he(t2 = 32) {
...
function Cn(t2, e2, n5, r3) {
  if (typeof t2.setBigUint64 == "function") return t2.setBigUint64(e2, n5, r3);
  const o5 = BigInt(32), s4 = BigInt(4294967295), a3 = Number(n5 >> o5 & s4), u3 = Number(n5 & s4), i5 = r3 ? 4 : 0, D2 = r3 ? 0 : 4;
  t2.setUint32(e2 + i5, a3, r3), t2.setUint32(e2 + D2, u3, r3);
}
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    const u3 = _t(e2), i5 = this.outputLen;
  ...
  _cloneInto(e2) {
    ...
    return e2.length = o5, e2.pos = u3, e2.finished = s4, e2.destroyed = a3, o5 % n5 && e2.buffer.set(r3), e2;
  }
};
...
function mn(t2, e2 = false) {
  ...
  for (let o5 = 0; o5 < t2.length; o5++) {
    const { h: s4, l: a3 } = le(t2[o5], e2);
    [n5[o5], r3[o5]] = [s4, a3];
  }
  return [n5, r3];
}
var _n = (t2, e2) => BigInt(t2 >>> 0) << St | BigInt(e2 >>> 0);
var Sn = (t2, e2, n5) => t2 >>> n5;
var vn = (t2, e2, n5) => t2 << 32 - n5 | e2 >>> n5;
var In = (t2, e2, n5) => t2 >>> n5 | e2 << 32 - n5;
var Un = (t2, e2, n5) => t2 << 32 - n5 | e2 >>> n5;
var Tn = (t2, e2, n5) => t2 << 64 - n5 | e2 >>> n5 - 32;
var Fn = (t2, e2, n5) => t2 >>> n5 - 32 | e2 << 64 - n5;
var Nn = (t2, e2) => e2;
var Ln = (t2, e2) => t2;
var On = (t2, e2, n5) => t2 << n5 | e2 >>> 32 - n5;
var Hn = (t2, e2, n5) => e2 << n5 | t2 >>> 32 - n5;
var zn = (t2, e2, n5) => e2 << n5 - 32 | t2 >>> 64 - n5;
var Mn = (t2, e2, n5) => t2 << n5 - 32 | e2 >>> 64 - n5;
function qn(t2, e2, n5, r3) {
  const o5 = (e2 >>> 0) + (r3 >>> 0);
  return { h: t2 + n5 + (o5 / 2 ** 32 | 0) | 0, l: o5 | 0 };
}
var $n = (t2, e2, n5) => (t2 >>> 0) + (e2 >>> 0) + (n5 >>> 0);
var kn = (t2, e2, n5, r3) => e2 + n5 + r3 + (t2 / 2 ** 32 | 0) | 0;
var Rn = (t2, e2, n5, r3) => (t2 >>> 0) + (e2 >>> 0) + (n5 >>> 0) + (r3 >>> 0);
var jn = (t2, e2, n5, r3, o5) => e2 + n5 + r3 + o5 + (t2 / 2 ** 32 | 0) | 0;
var Zn = (t2, e2, n5, r3, o5) => (t2 >>> 0) + (e2 >>> 0) + (n5 >>> 0) + (r3 >>> 0) + (o5 >>> 0);
var Gn = (t2, e2, n5, r3, o5, s4) => e2 + n5 + r3 + o5 + s4 + (t2 / 2 ** 32 | 0) | 0;
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n5, Bh: r3, Bl: o5, Ch: s4, Cl: a3, Dh: u3, Dl: i5, Eh: D2, El: c7, Fh: l8, Fl: p4, Gh: w4, Gl: h6, Hh: g4, Hl: S3 } = this;
    return [e2, n5, r3, o5, s4, a3, u3, i5, D2, c7, l8, p4, w4, h6, g4, S3];
  }
  set(e2, n5, r3, o5, s4, a3, u3, i5, D2, c7, l8, p4, w4, h6, g4, S3) {
    this.Ah = e2 | 0, this.Al = n5 | 0, this.Bh = r3 | 0, this.Bl = o5 | 0, this.Ch = s4 | 0, this.Cl = a3 | 0, this.Dh = u3 | 0, this.Dl = i5 | 0, this.Eh = D2 | 0, this.El = c7 | 0, this.Fh = l8 | 0, this.Fl = p4 | 0, this.Gh = w4 | 0, this.Gl = h6 | 0, this.Hh = g4 | 0, this.Hl = S3 | 0;
  }
  process(e2, n5) {
    for (let d5 = 0; d5 < 16; d5++, n5 += 4) P3[d5] = e2.getUint32(n5), Q[d5] = e2.getUint32(n5 += 4);
...
function Ft(t2) {
  Ut(t2);
  let e2 = "";
  for (let n5 = 0; n5 < t2.length; n5++) e2 += Xn[t2[n5]];
  return e2;
}
function pe(t2) {
...
function Qn(t2, e2, n5) {
  return Lt(t2) && Lt(e2) && Lt(n5) && e2 <= t2 && t2 < n5;
}
function ft(t2, e2, n5, r3) {
  if (!Qn(e2, n5, r3)) throw new Error("expected valid " + t2 + ": " + n5 + " <= n < " + r3 + ", got " + e2);
}
function tr(t2) {
  let e2;
...
function Ot(t2, e2, n5 = {}) {
  ...
  for (const [o5, s4] of Object.entries(e2)) r3(o5, s4, false);
...
function Ae(t2, e2) {
  ...
  let n5 = H(t2, e2), r3 = e2, o5 = M2, s4 = N2;
  for (; n5 !== M2; ) {
...
function sr(t2) {
  ...
  for (o5 = nt; o5 < t2 && or(o5, e2, t2) !== t2 - N2; o5++) if (o5 > 1e3) throw new Error("Cannot find square root: likely non-prime P");
  if (r3 === 1) {
    const a3 = (t2 + N2) / Ht;
  ...
  return function(u3, i5) {
    if (u3.pow(i5, e2) === u3.neg(u3.ONE)) throw new Error("Cannot find square root");
...
function ir(t2) {
  ...
  if (t2 % Ce === Be) {
    const e2 = (t2 - Be) / Ce;
    return function(r3, o5) {
      const s4 = r3.mul(o5, nt), a3 = r3.pow(s4, e2), u3 = r3.mul(o5, a3), i5 = r3.mul(r3.mul(u3, nt), a3), D2 = r3.mul(u3, r3.sub(i5, r3.ONE));
...
function Dr(t2, e2) {
  const n5 = new Array(e2.length), r3 = e2.reduce((s4, a3, u3) => t2.is0(a3) ? s4 : (n5[u3] = s4, t2.mul(s4, a3)), t2.ONE), o5 = t2.inv(r3);
  return e2.reduceRight((s4, a3, u3) => t2.is0(a3) ? s4 : (n5[u3] = t2.mul(s4, n5[u3]), t2.mul(s4, a3)), o5), n5;
}
function me(t2, e2) {
  const n5 = e2 !== void 0 ? e2 : t2.toString(2).length, r3 = Math.ceil(n5 / 8);
  return { nBitLength: n5, nByteLength: r3 };
}
function _e(t2, e2, n5 = false, r3 = {}) {
  if (t2 <= M2) throw new Error("invalid field: expected ORDER > 0, got " + t2);
  const { nBitLength: o5, nByteLength: s4 } = me(t2, e2);
...
function Mt(t2, e2) {
  ve(t2, e2);
  const n5 = Math.ceil(e2 / t2) + 1, r3 = 2 ** (t2 - 1);
...
function lr(t2, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n5) {
    ...
    const { windows: o5, windowSize: s4 } = Mt(r3, e2), a3 = [];
    let u3 = n5, i5 = u3;
    ...
    const { windows: s4, windowSize: a3 } = Mt(n5, e2);
    ...
    const { windows: a3, windowSize: u3 } = Mt(n5, e2), i5 = BigInt(2 ** n5 - 1), D2 = 2 ** n5, c7 = BigInt(n5);
...
function br(t2, e2, n5, r3) {
  if (dr(n5, t2), hr(r3, e2), n5.length !== r3.length) throw new Error("arrays of points and scalars must have equal length");
  const o5 = t2.ZERO, s4 = tr(BigInt(n5.length)), a3 = s4 > 12 ? s4 - 3 : s4 > 4 ? s4 - 2 : s4 ? 2 : 1, u3 = (1 << a3) - 1, i5 = new Array(u3 + 1).fill(o5), D2 = Math.floor((e2.BITS - 1) / a3) * a3;
  let c7 = o5;
...
function yr(t2) {
  const e2 = gr(t2), { Fp: n5, n: r3, prehash: o5, hash: s4, randomBytes: a3, nByteLength: u3, h: i5 } = e2, D2 = yt << BigInt(u3 * 8) - j2, c7 = n5.create, l8 = _e(e2.n, e2.nBitLength), p4 = e2.uvRatio || ((y5, f7) => {
    try {
      return { isValid: true, value: n5.sqrt(y5 * n5.inv(f7)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w4 = e2.adjustScalarBytes || ((y5) => y5), h6 = e2.domain || ((y5, f7, b4) => {
  ...
  class d5 {
    ...
    double() {
      const { a: f7 } = e2, { ex: b4, ey: E4, ez: B3 } = this, C5 = c7(b4 * b4), A2 = c7(E4 * E4), U2 = c7(yt * c7(B3 * B3)), _4 = c7(f7 * C5), T4 = b4 + E4, $ = c7(c7(T4 * T4) - C5 - A2), R2 = _4 + A2, V3 = R2 - U2, Y2 = _4 - A2, Z2 = c7($ * V3), X = c7(R2 * Y2), et3 = c7($ * Y2), pt2 = c7(V3 * R2);
      return new d5(Z2, X, pt2, et3);
    }
    add(f7) {
      S3(f7);
      const { a: b4, d: E4 } = e2, { ex: B3, ey: C5, ez: A2, et: U2 } = this, { ex: _4, ey: T4, ez: $, et: R2 } = f7;
      if (b4 === BigInt(-1)) {
    ...
    static fromHex(f7, b4 = false) {
      const { d: E4, a: B3 } = e2, C5 = n5.BYTES;
  ...
  return m4._setWindowSize(8), { CURVE: e2, getPublicKey: ot2, sign: st2, verify: Ct3, ExtendedPoint: d5, utils: { getExtendedPublicKey: O6, randomPrivateKey: () => a3(n5.BYTES), precompute(y5 = 8, f7 = d5.BASE) {
...
var Cr = BigInt(8);
function Ar(t2) {
  const e2 = BigInt(10), n5 = BigInt(20), r3 = BigInt(40), o5 = BigInt(80), s4 = kt, u3 = t2 * t2 % s4 * t2 % s4, i5 = J2(u3, Te, s4) * u3 % s4, D2 = J2(i5, xr, s4) * t2 % s4, c7 = J2(D2, Br, s4) * D2 % s4, l8 = J2(c7, e2, s4) * c7 % s4, p4 = J2(l8, n5, s4) * l8 % s4, w4 = J2(p4, r3, s4) * p4 % s4, h6 = J2(w4, o5, s4) * w4 % s4, g4 = J2(h6, o5, s4) * w4 % s4, S3 = J2(g4, e2, s4) * c7 % s4;
...
function _r(t2, e2) {
  const n5 = kt, r3 = H(e2 * e2 * e2, n5), o5 = H(r3 * r3 * e2, n5), s4 = Ar(t2 * o5).pow_p_5_8;
  let a3 = H(t2 * r3 * s4, n5);
  const u3 = H(e2 * a3 * a3, n5), i5 = a3, D2 = H(a3 * Ue, n5), c7 = u3 === t2, l8 = u3 === H(-t2, n5), p4 = u3 === H(-t2 * Ue, n5);
...
function Oe(t2, e2) {
  e2 || (e2 = t2.reduce((o5, s4) => o5 + s4.length, 0));
  const n5 = Le(e2);
  let r3 = 0;
...
var Bt = ({ name: t2, prefix: e2, encode: n5, decode: r3 }) => new zr(t2, e2, n5, r3);
var ht = ({ prefix: t2, name: e2, alphabet: n5 }) => {
  const { encode: r3, decode: o5 } = Tr(n5, e2);
  return Bt({ prefix: t2, name: e2, encode: r3, decode: (s4) => He(o5(s4)) });
};
var Mr = (t2, e2, n5, r3) => {
  const o5 = {};
...
var qr = (t2, e2, n5) => {
  ...
  let s4 = "", a3 = 0, u3 = 0;
  for (let i5 = 0; i5 < t2.length; ++i5) for (u3 = u3 << 8 | t2[i5], a3 += 8; a3 > n5; ) a3 -= n5, s4 += e2[o5 & u3 >> a3];
  if (a3 && (s4 += e2[o5 & u3 << n5 - a3]), r3) for (; s4.length * n5 & 7; ) s4 += "=";
  return s4;
};
var k4 = ({ name: t2, prefix: e2, bitsPerChar: n5, alphabet: r3 }) => Bt({ prefix: e2, name: t2, encode(o5) {
  return qr(o5, r3, n5);
}, decode(o5) {
...
var Me = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var go = Me.reduce((t2, e2, n5) => (t2[n5] = e2, t2), []);
var yo = Me.reduce((t2, e2, n5) => (t2[e2.codePointAt(0)] = n5, t2), []);
function xo(t2) {
  return t2.reduce((e2, n5) => (e2 += go[n5], e2), "");
}
function Bo(t2) {
  const e2 = [];
  for (const n5 of t2) {
...
function $e(t2, e2, n5) {
  e2 = e2 || [], n5 = n5 || 0;
  for (var r3 = n5; t2 >= vo; ) e2[n5++] = t2 & 255 | qe, t2 /= 128;
  for (; t2 & So; ) e2[n5++] = t2 & 255 | qe, t2 >>>= 7;
  return e2[n5] = t2 | 0, $e.bytes = n5 - r3 + 1, e2;
}
var Io = Pt;
var Uo = 128;
var ke = 127;
...
var Re = ko;
var je = (t2, e2, n5 = 0) => (Re.encode(t2, e2, n5), e2);
var Ze = (t2) => Re.encodingLength(t2);
var Qt = (t2, e2) => {
  const n5 = e2.byteLength, r3 = Ze(t2), o5 = r3 + Ze(n5), s4 = new Uint8Array(o5 + n5);
  return je(t2, s4, 0), je(n5, s4, r3), s4.set(e2, o5), new Ro(t2, n5, e2, s4);
};
var Ro = class {
  constructor(e2, n5, r3, o5) {
...
var Ge = ({ name: t2, code: e2, encode: n5 }) => new jo(t2, e2, n5);
var jo = class {
  constructor(e2, n5, r3) {
...
({ ...Vo, ...Wo });
function We(t2, e2, n5, r3) {
  return { name: t2, prefix: e2, encoder: { name: t2, prefix: e2, encode: n5 }, decoder: { decode: r3 } };
}
var Xe = We("utf8", "u", (t2) => "u" + new TextDecoder("utf8").decode(t2), (t2) => new TextEncoder().encode(t2.substring(1)));
var te = We("ascii", "a", (t2) => {
  let e2 = "a";
  for (let n5 = 0; n5 < t2.length; n5++) e2 += String.fromCharCode(t2[n5]);
  return e2;
}, (t2) => {
  t2 = t2.substring(1);
  const e2 = Le(t2.length);
  for (let n5 = 0; n5 < t2.length; n5++) e2[n5] = t2.charCodeAt(n5);
  return e2;
});
...
function ct(t2, e2 = "utf8") {
  ...
  return (e2 === "utf8" || e2 === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? globalThis.Buffer.from(t2.buffer, t2.byteOffset, t2.byteLength).toString("utf8") : n5.encoder.encode(t2).substring(1);
}
function rt(t2, e2 = "utf8") {
  const n5 = Pe[e2];
  if (!n5) throw new Error(`Unsupported encoding "${e2}"`);
  return (e2 === "utf8" || e2 === "utf-8") && globalThis.Buffer != null && globalThis.Buffer.from != null ? Xt(globalThis.Buffer.from(t2, "utf-8")) : n5.decoder.decode(`${n5.prefix}${t2}`);
}
function lt(t2) {
...
function Qe(t2) {
  const e2 = rt(Wt, dt), n5 = Kt + ct(Oe([e2, t2]), dt);
...
function sn(t2) {
  const e2 = t2.split(ut), n5 = lt(e2[0]), r3 = lt(e2[1]), o5 = nn(e2[2]), s4 = rt(e2.slice(0, 2).join(ut), xt);
...
async function Qo(t2, e2, n5, r3, o5 = (0, import_time2.fromMiliseconds)(Date.now())) {
  const s4 = { alg: jt, typ: Zt }, a3 = Qe(r3.publicKey), u3 = o5 + n5, i5 = { iss: a3, sub: t2, aud: e2, iat: o5, exp: u3 }, D2 = rn({ header: s4, payload: i5 }), c7 = Rt.sign(D2, r3.secretKey.slice(0, 32));
...
var cn = BigInt(32);
function Oo2(e2, t2 = false) {
  return t2 ? { h: Number(e2 & Ce2), l: Number(e2 >> cn & Ce2) } : { h: Number(e2 >> cn & Ce2) | 0, l: Number(e2 & Ce2) | 0 };
}
function Ao2(e2, t2 = false) {
  let n5 = new Uint32Array(e2.length), r3 = new Uint32Array(e2.length);
  for (let o5 = 0; o5 < e2.length; o5++) {
    const { h: s4, l: i5 } = Oo2(e2[o5], t2);
    [n5[o5], r3[o5]] = [s4, i5];
  }
  return [n5, r3];
}
var No2 = (e2, t2, n5) => e2 << n5 | t2 >>> 32 - n5;
var So2 = (e2, t2, n5) => t2 << n5 | e2 >>> 32 - n5;
var Uo2 = (e2, t2, n5) => t2 << n5 - 32 | e2 >>> 64 - n5;
var _o2 = (e2, t2, n5) => e2 << n5 - 32 | t2 >>> 64 - n5;
...
function un(e2) {
  for (let t2 = 0; t2 < e2.length; t2++) e2[t2] = $o2(e2[t2]);
}
function Ro2(e2) {
...
function fn(e2) {
  const t2 = (r3) => e2().update(we2(r3)).digest(), n5 = e2();
  return t2.outputLen = n5.outputLen, t2.blockLen = n5.blockLen, t2.create = () => e2(), t2;
}
function Se2(e2 = 32) {
...
var jo2 = BigInt(256);
var Co2 = BigInt(113);
for (let e2 = 0, t2 = Ue2, n5 = 1, r3 = 0; e2 < 24; e2++) {
...
var pn = (e2, t2, n5) => n5 > 32 ? Uo2(e2, t2, n5) : No2(e2, t2, n5);
var gn2 = (e2, t2, n5) => n5 > 32 ? _o2(e2, t2, n5) : So2(e2, t2, n5);
function Mo2(e2, t2 = 24) {
  const n5 = new Uint32Array(10);
  for (let r3 = 24 - t2; r3 < 24; r3++) {
    for (let i5 = 0; i5 < 10; i5++) n5[i5] = e2[i5] ^ e2[i5 + 10] ^ e2[i5 + 20] ^ e2[i5 + 30] ^ e2[i5 + 40];
    for (let i5 = 0; i5 < 10; i5 += 2) {
      const c7 = (i5 + 8) % 10, u3 = (i5 + 2) % 10, a3 = n5[u3], l8 = n5[u3 + 1], f7 = pn(a3, l8, 1) ^ n5[c7], d5 = gn2(a3, l8, 1) ^ n5[c7 + 1];
      for (let g4 = 0; g4 < 50; g4 += 10) e2[i5 + g4] ^= f7, e2[i5 + g4 + 1] ^= d5;
    }
    let o5 = e2[2], s4 = e2[3];
    for (let i5 = 0; i5 < 24; i5++) {
      const c7 = dn[i5], u3 = pn(o5, s4, c7), a3 = gn2(o5, s4, c7), l8 = ln[i5];
      o5 = e2[l8], s4 = e2[l8 + 1], e2[l8] = u3, e2[l8 + 1] = a3;
    }
    for (let i5 = 0; i5 < 50; i5 += 10) {
      for (let c7 = 0; c7 < 10; c7++) n5[c7] = e2[i5 + c7];
      for (let c7 = 0; c7 < 10; c7++) e2[i5 + c7] ^= ~n5[(c7 + 2) % 10] & n5[(c7 + 4) % 10];
    }
...
var Vo2 = (e2, t2, n5) => fn(() => new Lt2(t2, e2, n5));
...
function ds(e2, t2) {
  ...
  let n5 = 0;
  for (let r3 = 0; r3 < e2.length; r3++) n5 |= e2[r3] ^ t2[r3];
  return n5 === 0;
}
var hs = (e2, t2) => {
  function n5(r3, ...o5) {
    if (F(r3), e2.nonceLength !== void 0) {
      ...
      e2.varSizeNonce ? F(l8) : F(l8, e2.nonceLength);
    }
    const s4 = e2.tagLength;
...
function kn2(e2, t2, n5, r3) {
  if (typeof e2.setBigUint64 == "function") return e2.setBigUint64(t2, n5, r3);
  const o5 = BigInt(32), s4 = BigInt(4294967295), i5 = Number(n5 >> o5 & s4), c7 = Number(n5 & s4), u3 = r3 ? 4 : 0, a3 = r3 ? 0 : 4;
  e2.setUint32(t2 + u3, i5, r3), e2.setUint32(t2 + a3, c7, r3);
}
function ps(e2) {
...
function vs(e2, t2) {
  ...
  return ht2(o5), ht2(i5), jn2(s4), jn2(n5), (c7, u3, a3, l8, f7 = 0) => {
    ...
    const _4 = se(u3);
    return Es(e2, m4, L3, _4, a3, l8, f7, i5), Ee2(...g4), l8;
  };
}
var M3 = (e2, t2) => e2[t2++] & 255 | (e2[t2++] & 255) << 8;
var xs = class {
  constructor(t2) {
...
function Is(e2) {
  const t2 = (r3, o5) => e2(o5).update(pt(r3)).digest(), n5 = e2(new Uint8Array(32));
  return t2.outputLen = n5.outputLen, t2.blockLen = n5.blockLen, t2.create = (r3) => e2(r3), t2;
}
var Os = Is((e2) => new xs(e2));
function As(e2, t2, n5, r3, o5, s4 = 20) {
  let i5 = e2[0], c7 = e2[1], u3 = e2[2], a3 = e2[3], l8 = t2[0], f7 = t2[1], d5 = t2[2], g4 = t2[3], y5 = t2[4], h6 = t2[5], m4 = t2[6], L3 = t2[7], b4 = o5, _4 = n5[0], O6 = n5[1], k5 = n5[2], E4 = i5, B3 = c7, j4 = u3, v5 = a3, I3 = l8, w4 = f7, R2 = d5, A2 = g4, T4 = y5, N10 = h6, S3 = m4, U2 = L3, $ = b4, p4 = _4, C5 = O6, D2 = k5;
...
function Kn2(e2, t2, n5, r3, o5) {
  const s4 = e2(t2, n5, Us), i5 = Os.create(s4);
...
var _s = (e2) => (t2, n5, r3) => ({ encrypt(s4, i5) {
  const c7 = s4.length;
  i5 = Cn2(c7 + 16, i5, false), i5.set(s4);
  const u3 = i5.subarray(0, -16);
  e2(t2, n5, u3, u3, 1);
  const a3 = Kn2(e2, t2, n5, u3, r3);
  return i5.set(a3, c7), Ee2(a3), i5;
}, decrypt(s4, i5) {
  i5 = Cn2(s4.length - 16, i5, false);
  const c7 = s4.subarray(0, -16), u3 = s4.subarray(-16), a3 = Kn2(e2, t2, n5, c7, r3);
  if (!ds(u3, a3)) throw new Error("invalid tag");
  return i5.set(s4.subarray(0, -16)), e2(t2, n5, i5, i5, 1), Ee2(a3), i5;
} });
...
var mt = (e2, t2, n5) => new qn2(e2, t2).update(n5).digest();
mt.create = (e2, t2) => new qn2(e2, t2);
var bt2 = new Uint8Array([0]);
var Gn2 = new Uint8Array();
function Ps(e2, t2, n5, r3) {
  if (typeof e2.setBigUint64 == "function") return e2.setBigUint64(t2, n5, r3);
  const o5 = BigInt(32), s4 = BigInt(4294967295), i5 = Number(n5 >> o5 & s4), c7 = Number(n5 & s4), u3 = r3 ? 4 : 0, a3 = r3 ? 0 : 4;
  e2.setUint32(t2 + u3, i5, r3), e2.setUint32(t2 + a3, c7, r3);
}
function Bs(e2, t2, n5) {
  return e2 & t2 ^ ~e2 & n5;
}
function Ls(e2, t2, n5) {
  return e2 & t2 ^ e2 & n5 ^ t2 & n5;
}
...
function Ms(e2) {
  zn2(e2);
  let t2 = "";
  for (let n5 = 0; n5 < e2.length; n5++) t2 += Ds[e2[n5]];
  return t2;
}
function Vs(e2) {
...
function Yn2(e2) {
  if (typeof e2 != "string") throw new Error("hex string expected, got " + typeof e2);
  const t2 = e2.length, n5 = t2 / 2;
  if (t2 % 2) throw new Error("hex string expected, got unpadded hex of length " + t2);
  const r3 = new Uint8Array(n5);
  for (let o5 = 0, s4 = 0; o5 < n5; o5++, s4 += 2) {
    const i5 = Jn2(e2.charCodeAt(s4)), c7 = Jn2(e2.charCodeAt(s4 + 1));
    if (i5 === void 0 || c7 === void 0) {
      const u3 = e2[s4] + e2[s4 + 1];
...
function Hs(e2, t2) {
  return Yn2(e2.toString(16).padStart(t2 * 2, "0"));
}
function Ks(e2, t2) {
  return Hs(e2, t2).reverse();
}
function Zn2(e2, t2, n5) {
  let r3;
  if (typeof t2 == "string") try {
    r3 = Yn2(t2);
  } catch (s4) {
    throw new Error(e2 + " must be hex string or Uint8Array, cause: " + s4);
  }
  else if (wt2(t2)) r3 = Uint8Array.from(t2);
  else throw new Error(e2 + " must be hex string or Uint8Array");
  const o5 = r3.length;
  if (typeof n5 == "number" && o5 !== n5) throw new Error(e2 + " of length " + n5 + " expected, got " + o5);
  return r3;
}
var Et2 = (e2) => typeof e2 == "bigint" && Wn2 <= e2;
function Fs(e2, t2, n5) {
  return Et2(e2) && Et2(t2) && Et2(n5) && t2 <= e2 && e2 < n5;
}
function Qn2(e2, t2, n5, r3) {
  if (!Fs(t2, n5, r3)) throw new Error("expected valid " + e2 + ": " + n5 + " <= n < " + r3 + ", got " + t2);
}
var qs = { bigint: (e2) => typeof e2 == "bigint", function: (e2) => typeof e2 == "function", boolean: (e2) => typeof e2 == "boolean", string: (e2) => typeof e2 == "string", stringOrUint8Array: (e2) => typeof e2 == "string" || wt2(e2), isSafeInteger: (e2) => Number.isSafeInteger(e2), array: (e2) => Array.isArray(e2), field: (e2, t2) => t2.Fp.isValid(e2), hash: (e2) => typeof e2 == "function" && Number.isSafeInteger(e2.outputLen) };
function Gs(e2, t2, n5 = {}) {
  const r3 = (o5, s4, i5) => {
    const c7 = qs[s4];
    if (typeof c7 != "function") throw new Error("invalid validator function");
    const u3 = e2[o5];
    if (!(i5 && u3 === void 0) && !c7(u3, e2)) throw new Error("param " + String(o5) + " is invalid. Expected " + s4 + ", got " + u3);
  };
...
function Ws(e2, t2, n5) {
  ...
  let r3 = Ke2;
  for (; t2 > ve2; ) t2 & Ke2 && (r3 = r3 * e2 % n5), e2 = e2 * e2 % n5, t2 >>= Ke2;
  return r3;
}
function z3(e2, t2, n5) {
  let r3 = e2;
...
function Js(e2) {
  const t2 = zs(e2), { P: n5 } = t2, r3 = (b4) => er2(b4, n5), o5 = t2.montgomeryBits, s4 = Math.ceil(o5 / 8), i5 = t2.nByteLength, c7 = t2.adjustScalarBytes || ((b4) => b4), u3 = t2.powPminus2 || ((b4) => Ws(b4, n5 - BigInt(2), n5));
...
BigInt(8);
function Qs(e2) {
  const t2 = BigInt(10), n5 = BigInt(20), r3 = BigInt(40), o5 = BigInt(80), s4 = xt2, c7 = e2 * e2 % s4 * e2 % s4, u3 = z3(c7, tr2, s4) * c7 % s4, a3 = z3(u3, Ys, s4) * e2 % s4, l8 = z3(a3, Zs, s4) * a3 % s4, f7 = z3(l8, t2, s4) * l8 % s4, d5 = z3(f7, n5, s4) * f7 % s4, g4 = z3(d5, r3, s4) * d5 % s4, y5 = z3(g4, o5, s4) * g4 % s4, h6 = z3(y5, o5, s4) * g4 % s4, m4 = z3(h6, t2, s4) * l8 % s4;
  return { pow_p_5_8: z3(m4, tr2, s4) * e2 % s4, b2: c7 };
}
function ei(e2) {
...
var It2 = Js({ P: xt2, a: BigInt(486662), montgomeryBits: 255, nByteLength: 32, Gu: BigInt(9), powPminus2: (e2) => {
  const t2 = xt2, { pow_p_5_8: n5, b2: r3 } = Qs(e2);
...
var f5 = class {
  ...
  register(e2 = this.url) {
    ...
    return this.url = e2, this.registering = true, new Promise((t2, n5) => {
      const s4 = (0, esm_exports.isReactNative)() ? void 0 : { rejectUnauthorized: !isLocalhostUrl(e2) }, o5 = new b3(e2, [], s4);
      w2() ? o5.onerror = (i5) => {
        const a3 = i5;
  ...
  onError(e2, t2) {
    const n5 = this.parseError(t2), s4 = n5.message || n5.toString(), o5 = formatJsonRpcError(e2, s4);
  ...
  emitError(e2) {
    const t2 = this.parseError(new Error(e2?.message || `WebSocket connection failed for host: ${d3(this.url)}`));
...
var cr2 = class {
  constructor(e2, t2, s4) {
    this.name = e2, this.prefix = t2, this.baseEncode = s4;
  }
  encode(e2) {
    if (e2 instanceof Uint8Array) return `${this.prefix}${this.baseEncode(e2)}`;
    throw Error("Unknown type, must be binary type");
...
var lr2 = class {
  ...
  decode(e2) {
    const t2 = e2[0], s4 = this.decoders[t2];
    if (s4) return s4.decode(e2);
    throw RangeError(`Unable to decode multibase string ${JSON.stringify(e2)}, only inputs prefixed with ${Object.keys(this.decoders)} are supported`);
  }
};
var ri2 = (r3, e2) => new lr2({ ...r3.decoders || { [r3.prefix]: r3 }, ...e2.decoders || { [e2.prefix]: e2 } });
var ur2 = class {
  constructor(e2, t2, s4, i5) {
    this.name = e2, this.prefix = t2, this.baseEncode = s4, this.baseDecode = i5, this.encoder = new cr2(e2, t2, s4), this.decoder = new hr2(e2, t2, i5);
  }
  encode(e2) {
    return this.encoder.encode(e2);
  }
...
var Ee3 = ({ name: r3, prefix: e2, encode: t2, decode: s4 }) => new ur2(r3, e2, t2, s4);
var de3 = ({ prefix: r3, name: e2, alphabet: t2 }) => {
  const { encode: s4, decode: i5 } = nr2(t2, e2);
  return Ee3({ prefix: r3, name: e2, encode: s4, decode: (n5) => si2(i5(n5)) });
};
var dr2 = (r3, e2, t2, s4) => {
  const i5 = {};
  for (let u3 = 0; u3 < e2.length; ++u3) i5[e2[u3]] = u3;
  let n5 = r3.length;
  for (; r3[n5 - 1] === "="; ) --n5;
...
var gr2 = (r3, e2, t2) => {
  const s4 = e2[e2.length - 1] === "=", i5 = (1 << t2) - 1;
  let n5 = "", o5 = 0, a3 = 0;
  for (let c7 = 0; c7 < r3.length; ++c7) for (a3 = a3 << 8 | r3[c7], o5 += 8; o5 > t2; ) o5 -= t2, n5 += e2[i5 & a3 >> o5];
  if (o5 && (n5 += e2[i5 & a3 << t2 - o5]), s4) for (; n5.length * t2 & 7; ) n5 += "=";
  return n5;
};
var P4 = ({ name: r3, prefix: e2, bitsPerChar: t2, alphabet: s4 }) => Ee3({ prefix: e2, name: r3, encode(i5) {
  return gr2(i5, s4, t2);
}, decode(i5) {
...
var ni = Array.from("🚀🪐☄🛰🌌🌑🌒🌓🌔🌕🌖🌗🌘🌍🌏🌎🐉☀💻🖥💾💿😂❤😍🤣😊🙏💕😭😘👍😅👏😁🔥🥰💔💖💙😢🤔😆🙄💪😉☺👌🤗💜😔😎😇🌹🤦🎉💞✌✨🤷😱😌🌸🙌😋💗💚😏💛🙂💓🤩😄😀🖤😃💯🙈👇🎶😒🤭❣😜💋👀😪😑💥🙋😞😩😡🤪👊🥳😥🤤👉💃😳✋😚😝😴🌟😬🙃🍀🌷😻😓⭐✅🥺🌈😈🤘💦✔😣🏃💐☹🎊💘😠☝😕🌺🎂🌻😐🖕💝🙊😹🗣💫💀👑🎵🤞😛🔴😤🌼😫⚽🤙☕🏆🤫👈😮🙆🍻🍃🐶💁😲🌿🧡🎁⚡🌞🎈❌✊👋😰🤨😶🤝🚶💰🍓💢🤟🙁🚨💨🤬✈🎀🍺🤓😙💟🌱😖👶🥴▶➡❓💎💸⬇😨🌚🦋😷🕺⚠🙅😟😵👎🤲🤠🤧📌🔵💅🧐🐾🍒😗🤑🌊🤯🐷☎💧😯💆👆🎤🙇🍑❄🌴💣🐸💌📍🥀🤢👅💡💩👐📸👻🤐🤮🎼🥵🚩🍎🍊👼💍📣🥂");
var Gr2 = ni.reduce((r3, e2, t2) => (r3[t2] = e2, r3), []);
var Wr2 = ni.reduce((r3, e2, t2) => (r3[e2.codePointAt(0)] = t2, r3), []);
function Hr2(r3) {
  return r3.reduce((e2, t2) => (e2 += Gr2[t2], e2), "");
}
function Yr3(r3) {
  const e2 = [];
  for (const t2 of r3) {
...
function ai2(r3, e2, t2) {
  e2 = e2 || [], t2 = t2 || 0;
  for (var s4 = t2; r3 >= tn; ) e2[t2++] = r3 & 255 | oi2, r3 /= 128;
  for (; r3 & en2; ) e2[t2++] = r3 & 255 | oi2, r3 >>>= 7;
  return e2[t2] = r3 | 0, ai2.bytes = t2 - s4 + 1, e2;
}
var sn3 = Fe2;
var rn2 = 128;
var ci2 = 127;
...
var hi2 = yn2;
var li2 = (r3, e2, t2 = 0) => (hi2.encode(r3, e2, t2), e2);
var ui2 = (r3) => hi2.encodingLength(r3);
var Ke3 = (r3, e2) => {
  const t2 = e2.byteLength, s4 = ui2(r3), i5 = s4 + ui2(t2), n5 = new Uint8Array(i5 + t2);
  return li2(r3, n5, 0), li2(t2, n5, s4), n5.set(e2, i5), new bn2(r3, t2, e2, n5);
};
var bn2 = class {
  constructor(e2, t2, s4, i5) {
    this.code = e2, this.size = t2, this.digest = s4, this.bytes = i5;
  }
};
var di2 = ({ name: r3, code: e2, encode: t2 }) => new mn2(r3, e2, t2);
var mn2 = class {
  constructor(e2, t2, s4) {
    this.name = e2, this.code = t2, this.encode = s4;
  }
  digest(e2) {
    if (e2 instanceof Uint8Array) {
...
function mi2(r3, e2, t2, s4) {
  return { name: r3, prefix: e2, encoder: { name: r3, prefix: e2, encode: t2 }, decoder: { decode: s4 } };
}
var fi2 = mi2("utf8", "u", (r3) => "u" + new TextDecoder("utf8").decode(r3), (r3) => new TextEncoder().encode(r3.substring(1)));
var Be2 = mi2("ascii", "a", (r3) => {
  let e2 = "a";
  for (let t2 = 0; t2 < r3.length; t2++) e2 += String.fromCharCode(r3[t2]);
  return e2;
}, (r3) => {
  r3 = r3.substring(1);
  const e2 = Tn2(r3.length);
  for (let t2 = 0; t2 < r3.length; t2++) e2[t2] = r3.charCodeAt(t2);
  return e2;
});
...
var l7 = (r3, t2, e2) => t2 in r3 ? P5(r3, t2, { enumerable: true, configurable: true, writable: true, value: e2 }) : r3[t2] = e2;
var p3 = (r3, t2) => {
  for (var e2 in t2 || (t2 = {})) L2.call(t2, e2) && l7(r3, e2, t2[e2]);
  if (c6) for (var e2 of c6(t2)) O5.call(t2, e2) && l7(r3, e2, t2[e2]);
  return r3;
};
...
var f6 = class {
  constructor(t2, e2 = false) {
    if (this.url = t2, this.disableProviderPing = e2, this.events = new import_events9.EventEmitter(), this.isAvailable = false, this.registering = false, !isHttpUrl(t2)) throw new Error(`Provided URL is not compatible with HTTP connection: ${t2}`);
    this.url = t2, this.disableProviderPing = e2;
  }
  get connected() {
  ...
  async send(t2) {
    ...
    try {
      const e2 = safeJsonStringify(t2), s4 = await (await (0, import_cross_fetch.default)(this.url, v4(p3({}, d4), { body: e2 }))).json();
      this.onPayload({ data: s4 });
    } catch (e2) {
      this.onError(t2.id, e2);
    }
  }
  async register(t2 = this.url) {
    ...
    if (this.registering) {
      ...
      return (this.events.listenerCount("register_error") >= e2 || this.events.listenerCount("open") >= e2) && this.events.setMaxListeners(e2 + 1), new Promise((s4, i5) => {
    ...
    try {
      if (!this.disableProviderPing) {
        ...
        await (0, import_cross_fetch.default)(t2, v4(p3({}, d4), { body: e2 }));
      }
      this.onOpen();
    } catch (e2) {
      const s4 = this.parseError(e2);
  ...
  onPayload(t2) {
    ...
    const e2 = typeof t2.data == "string" ? safeJsonParse(t2.data) : t2.data;
    this.events.emit("payload", e2);
  }
  onError(t2, e2) {
    const s4 = this.parseError(e2), i5 = s4.message || s4.toString(), n5 = formatJsonRpcError(t2, i5);
    this.events.emit("payload", n5);
  }
  parseError(t2, e2 = this.url) {
    return parseConnectionError(t2, e2, "HTTP");
  }
  resetMaxListeners() {
...
async function recoverPublicKey2({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k14 } = await import("./secp256k1-T2XE223O.js");
  const signature_ = (() => {
...
function blobsToCommitments2(parameters) {
  ...
  return to3 === "bytes" ? commitments : commitments.map((x6) => bytesToHex(x6));
}
...
function blobsToProofs2(parameters) {
  ...
  return to3 === "bytes" ? proofs : proofs.map((x6) => bytesToHex(x6));
}
...
function toBlobs2(parameters) {
  ...
  return to3 === "bytes" ? blobs.map((x6) => x6.bytes) : blobs.map((x6) => bytesToHex(x6.bytes));
}
...
async function prepareTransactionRequest2(client, args) {
  ...
  request.parameters ??= defaultParameters2;
...
function schnorrSign(message, privateKey, auxRand = randomBytes(32)) {
  ...
  sig.set(rx, 0);
  sig.set(numTo32b(modN(k5 + e2 * d5)), 32);
...
function schnorrVerify(signature, message, publicKey) {
  ...
  try {
    ...
    const R2 = GmulAdd(P6, s4, modN(-e2));
...
var EnsController = {
  ...
  async registerName(name2) {
    ...
    try {
      ...
      const errorMessage = this.parseEnsApiError(e2, `Error registering name ${name2}`);
...
//# sourceMappingURL=chunk-EVA7D7M4.js.map
